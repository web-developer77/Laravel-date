        ...
        <li class="tutor row tutor1 tutor_success">
            ...
            <div class="description col-md-7 col-sm-8">
                <div class="first-line">
                    ...
                    <img alt="Russia" class="CountryFlagImg___83cde CountryFlagImgEnabled___39BAf"
                        src="https://static.preply.com/images/new/flags-svg/4x3/ru.svg" width="16px" height="12px">
                    <svg class="VerifiedTutorIcon___1Sswo" width="16" height="19" viewBox="0 0 16 19" fill="none"
                ...
                <div class="second-line">
                    ...
                    <svg class="SubjectsIcon___HZRQn" width="13" height="10" viewBox="129 34 13 10"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                ...
                <div class="third-line">
                    <svg class="ActiveStudentsIcon___3gdmX" width="10" height="10" viewBox="0 0 10 10"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M4.582 4.834a2.42 2.42 0 0 0 2.417-2.417A2.42 2.42 0 0 0 4.582 0a2.42 2.42 0 0 0-2.417 2.417 2.42 2.42 0 0 0 2.417 2.417zm4.45 4.999a4.456 4.456 0 0 0-4.45-4.423 4.456 4.456 0 0 0-4.45 4.451c0 .077.061.139.138.139h8.627a.139.139 0 0 0 .136-.167z">
                        </path>
                    </svg>
                    ...
                    <ul class="lang_sel">
                        ...
                        <li class="SpeaksItem___28ZUB"> {{ $Tutors->native_language }}:Native &nbsp &nbsp
                            {{ $Tutors->also }} (also)<span
                                class="SpeaksLevel___2Fg_I SpeaksLevelGreen___3JBst"></span></li>
                ...
                <div class="forth-line">
                    <div>
                        ...
                        <a class="SeoSnippetViewProfileCTA___2DxQQ" 
                            target="_blank" data-clickable-element="true">View full profile<svg
                                class="NewTabArrow___3JMhK" width="12" height="12" viewBox="0 0 12 12" fill="none"
                                xmlns="#">
                                <path d="M6 1.75l4.243 4.243m0 0H1.757m8.486 0L6 10.235" stroke="#3BB3BD"
            ...
            <div class="content col-md-3">
                <div class="CoreIndicatorsWrap____8r4Z">
                    <div class="CoreIndicatorsItem___1niNK">
                        <div class="RatingIndicator___1x9Q_">
                            <div class="RatingIndicatorRating___374zP"><svg height="23" viewBox="0 0 24 23" width="24"
                                    xmlns="http://www.w3.org/2000/svg" class="RatingStarIcon___1RRIx">
                                    <path
                            ...
                            <button class="RatingIndicatorText___2oEyE RatingLink___ZkkaE"
                    ...
                    <div class="CoreIndicatorsItem___1niNK">
                        <div class="PriceIndicator___1doEU">
                            <div class="PriceIndicatorPrice___w9jW1">
                                <div class="">$</div>
                                <div class="PriceIndicatorValue___1kV4p PriceIndicatorValueSecond___1vI6H"
                                    data-qa-group="tutor-price-value">{{ $Tutors->tuition }}</div>
                            </div>
                ...
                <div class="btns  row">
                    <div class="btn_1 col-md-12 "> <a href="/zoom" class="btn btn-primary btn-2">Link
                            Zoom</a> </div>
                    <div class="btn_1 col-md-12 "> <a href="/payment_select" class="btn btn-success btn-2">Make a Payment
                            </a> </div>
                    <div class="btn_1 col-md-12 "> <button type="button" class="btn btn-info btn-2">Timetable</button>
                    </div>
                </div>
            </div>
        </li>
